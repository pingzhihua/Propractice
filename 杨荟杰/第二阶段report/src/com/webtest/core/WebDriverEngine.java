...
//		 List<WebElement> eles = beCommand.getWebDriver().findElementsByID(id);
//		 WebDriver driver=beCommand.getWebDriver();
//		 JavascriptExecutor js = (JavascriptExecutor) driver;
//		 for (WebElement ele : eles)
//		 {
//			 js.executeScript("arguments[0].style.display='inline';",ele);
//		 }
//	}
