...
public class team1 extends login {
	...
	public void testTeam25() throws InterruptedException {
		...
		// 页面自动跳转的科幻论坛页面
		assertTrue(webtest.isTextPresent("跳转成功"));
	...
	public void testTeam27() throws InterruptedException {
		...
		webtest.click("xpath=//*[@id='submit']");
		// 页面提示保存失败，内容不能为空
		assertTrue(webtest.isTextPresent("保存失败"));
	}
	...
	public void testTeam30() throws InterruptedException {
		...
		assertTrue(webtest.isTextPresent("显示成功"));
	}
	...
	public void testTeam38() throws InterruptedException {
		// 点击后台管理
		Thread.sleep(5000);
		webtest.mouseoverElement("xpath=//*[@id='s-menu-superadmin']/button");
